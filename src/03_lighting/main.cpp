...
int main()
{
    ...
    /*-------------------------------↓ Custom ↓---------------------------------*/
    Shader cubeShader(R"(D:\CODE\OpenGLxvsc\src\03_lighting\shader.vs)", "D:\\CODE\\OpenGLxvsc\\src\\03_lighting\\shader.fs");
    Shader lightShader(R"(D:\CODE\OpenGLxvsc\src\03_lighting\lightshader.vs)", R"(D:\CODE\OpenGLxvsc\src\03_lighting\lightshader.fs)");
    ...
    unsigned int diffusemap  = loadTexture(R"(D:\CODE\OpenGLxvsc\src\03_lighting\container2.png)");
    unsigned int specularmap = loadTexture(R"(D:\CODE\OpenGLxvsc\src\03_lighting\container2_specular.png)");
    cubeShader.use();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        /* lightPos.x = sin(currentFrame) * 3;
        lightPos.z = cos(currentFrame) * 3; */
        ...
        cubeShader.setVec3("viewPos", camera._position);
...
void processInput(GLFWwindow* window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS)
        camera.move(MOVEMENT::CLIMB, deltaTime);
    if (glfwGetKey(window, GLFW_KEY_Q) == GLFW_PRESS)
        camera.move(MOVEMENT::DESCENT, deltaTime);
}
