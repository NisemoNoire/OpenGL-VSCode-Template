...
int main()
{
    ...
    /*-------------------------------↓ Custom ↓---------------------------------*/
    std::filesystem::path vs("../src/01_window/shader.vs");
    std::filesystem::path fs("../src/01_window/shader.fs");
    ...
    vs = "../src/01_window/container.jpg";
    ...
    vs = "../src/01_window/awesomeface.png";
    /* 加载图像并绑定 */
